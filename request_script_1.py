...
input_file = open('data/league_id_10979_starladder_s2.json') 
...
with open('data/league_id_10979_starladder_s2_matchdata.json', 'w') as data_file:
	json.dump(responses, data_file, indent= 4)