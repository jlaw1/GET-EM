...
input_file = open('match_list/league_id_10826_epicenter_2019.json') 
...
f = open('Patch_722_matchdata/league_id_10826_epicenter_2019_matchdata_2.json', 'w')
i = 1 # I think you set i=1 instead of i=0, otherwise you get a double print of first match 
for m in matches:
