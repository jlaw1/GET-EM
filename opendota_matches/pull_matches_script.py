# !! Patch 7.22 pro dota matches online/lan by league_id 
# List of matches by match_id for each tournament 
# 1. league_id_10749_ti9.json
# 2. league_id_10979_starladder_s2.json
# 3. league_id_10826_epicenter_2019.json
# 4. league_id_11280_chengdu.json
# 5. league_id_11371_summit_11.json

# Coresponding coresponding match data by tournament
...
f = open('Patch_722_matchdata/league_id_10749_ti9_matchdata.json', 'w')
i = 0 
for m in matches:
